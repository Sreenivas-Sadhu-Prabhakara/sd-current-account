package com.bank.bian.currentaccount.model;
...
/**
 * The BIAN control record for this service domain: "Current Account Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Current Account Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Current Account Facility Fulfillment Arrangement";
